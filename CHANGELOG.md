...
- [#9](https://github.com/cyberk-dev/ultrareview-action/pull/9) [`2e8b729`](https://github.com/cyberk-dev/ultrareview-action/commit/2e8b729aebdcda28fc822ae66ced762cd0a2c937) Thanks [@TuNbCyberk](https://github.com/TuNbCyberk)! - Fix flow diagram missing from LGTM PR comments (no-bug PRs).
